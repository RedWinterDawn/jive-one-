...
//
//  Modified by Eduardo Gueiros on 03/04/2014
...
{
    if ([self.delegate respondsToSelector:@selector(contactPickerDidBecomeFirstResponder:)]) {
        [self.delegate contactPickerDidBecomeFirstResponder:textView];
    }
}
