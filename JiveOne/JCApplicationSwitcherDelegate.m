...
@interface JCApplicationSwitcherDelegate ()
{
    ...
    JCAuthManager *_authenticationManager;
}
...
-(instancetype)initWithAppsSettings:(JCAppSettings *)appSettings authenticationManager:(JCAuthManager *)authenticationManager
{
    self = [super init];
    if (self) {
